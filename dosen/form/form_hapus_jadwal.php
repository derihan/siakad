        ...
        <div class="modal-body">
                ...
                <div class="form-group" style="padding-bottom: 10px;">
				 ...
				 <div class="form-group" style="padding-bottom: 10px;">
					...
					<input type="text" name="nama" value="<?php echo $row['jam']?>" style="height: 30px; visibility: hidden;"/>
                    <label class="form-control"><?php echo $row['jam'] ?></label>
                </div>
				<div class="form-group" style="padding-bottom: 10px;">
                    <label for="Description">Jam</label>
					<input type="text" name="nama" value="<?php echo $row['hari']?>" style="height: 30px; visibility: hidden;"/>
