			...
			<div class="col-md-12">
				...
				<?php
					...
					if (isset($_GET['dosen'])){
						if($_GET['dosen']=='false'){
				?>
				<div class="alert bg-warning" role="alert"><em class="fa fa-lg fa-warning">&nbsp;</em> Dosen Belum Terdaftar <a href="#" class="pull-right"><em class="fa fa-lg fa-close"></em></a></div>
				<?php
						}
					}
				?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body mx-3">
		...
		<div class="md-form mb-5">
          ...
          <input type="text" id="form3" class="form-control validate" name="id_dosen" style="height: 30px;" required>
        </div>
		 <div class="md-form mb-5">
