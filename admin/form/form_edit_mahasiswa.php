<?php
	...
	$id = $_GET['NIM'];
	$query = mysqli_query($connect,"select*from mahasiswa where NIM='$id'");
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="modal-body">
            <form action="control/ctrl_edit_mhs.php" name="modal_popup" enctype="multipart/form-data" method="POST">
                
                <div class="form-group">
                    <label for="Modal Name">NIM</label>
                    <input type="text" name="nim"  value="<?php echo $row[0] ?>" style="height: 30px; visibility: hidden;" />
				...
				<div class="form-group" style="padding-bottom: 10px;">
                    <label for="Date">Agama</label>       
                    <input type="text" name="agama"  class="form-control" value="<?php echo $row[4]?>" style="height: 30px;" />
                </div>
				<div class="form-group" style="padding-bottom: 10px;">
                    <p>
			 ...
			 <select name="prodi" class="form-control validate">
			 <?php
			...
			<?php
			 ...
			 ?>
				...
				<div class="form-group" style="padding-bottom: 10px;">
                    <label for="Date">Angkatan</label>       
                    <input type="text" name="angkatan"  class="form-control" value="<?php echo $row[6]?>" style="height: 30px;"/>
                </div>
